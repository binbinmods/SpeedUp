...
namespace SpeedUp
{
    ...
    public class Plugin : BaseUnityPlugin
    {
        ...
        private void Awake()
        {
            ...
            EnableUltrafast = Config.Bind(new ConfigDefinition(modName, "EnableUltrafast"), false, new ConfigDescription("Enables ultrafast mode."));
            SpeedModifier = Config.Bind(new ConfigDefinition(modName, "SpeedModifier"), 1.0f, new ConfigDescription("Sets the speed modifier for the game."));
            ...
            // Check for config update and then process it
            EnableUltrafast.SettingChanged += (obj, args) => { HandleUltraFast(); };
            SpeedModifier.SettingChanged += (obj, args) => { HandleSpeedChange(); };
